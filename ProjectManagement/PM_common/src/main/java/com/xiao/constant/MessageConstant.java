...
public class MessageConstant {
    ...
    public static final String LOGIN_STATUS_TEACHER = "LOGIN_STATUS_TEACHER";
    public static final String LOGIN_STATUS_STUDENT = "LOGIN_STATUS_STUDENT";


    public static final String LOGIN_FAIL = "账号错误或者密码错误";
    public static final String LOGIN_SUCCESS = "登录成功";
    public static final String REGISTER_FAIL = "注册失败";
    public static final String REGISTER_SUCCESS = "注册成功";

    public static final String FIND_NOTIFICATION_SUCCESS = "查找通知成功";
    public static final String FIND_NOTIFICATION_FAIL = "查找通知失败";

    public static final String FIND_INVITATION_SUCCESS = "查找邀请成功";
    public static final String FIND_INVITATION__FAIL = "查找邀请失败";

    public static final String FIND_SUCCESS="查找成功";
    public static final String MODIFY_SUCCESS="修改成功";


    public static final String FIND_TEAM_DETAIL_SUCCESS="查找成功";

    public static final String FIND_TASK_TEAM_SUCCESS="查找成功";

    public static final String GO_AWAY_TEAM_SUCCESS="退队成功";

    public static final String LOGOUT_SUCCESS="退出登入成功";
